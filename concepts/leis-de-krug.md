...
- Cada dúvida consome do estoque limitado de paciência/boa vontade ([reservatorio-boa-vontade](../concepts/reservatorio-boa-vontade.md))
...
- Conexão com Weinschenk: [cognicao-pensamento](../concepts/cognicao-pensamento.md) — progressive disclosure e cognitive load. [memoria-cognicao](../concepts/memoria-cognicao.md) — working memory limitada a 4 items justifica não sobrecarregar. [atencao-foco](../concepts/atencao-foco.md) — atenção de 7-10 min, scanning
...
- Conexão: [cognicao-pensamento](../concepts/cognicao-pensamento.md) — Fitt's Law, trade-off clicks vs thinking. Cognitive load < Visual load < Motor load
...
- Conexão: [leitura-tipografia](../concepts/leitura-tipografia.md) — pessoas escaneiam, não leem. [atencao-foco](../concepts/atencao-foco.md) — salient cues
...
- Conexão: [percepcao-visual](../concepts/percepcao-visual.md) — scanning de telas, pessoas ignoram bordas. [atencao-foco](../concepts/atencao-foco.md) — atenção seletiva, captadores de atenção (perigo, comida, sexo)
...
- Conexão: [tomada-decisao](../concepts/tomada-decisao.md) — decisões inconscientes (Bechara). [processamento-inconsciente](../concepts/processamento-inconsciente.md) — maioria do processamento é inconsciente
...
- Conexão: [erros-usabilidade](../concepts/erros-usabilidade.md) — tipos de erros previsíveis. [cognicao-pensamento](../concepts/cognicao-pensamento.md) — modelos mentais
...
Ver também: [nao-me-faca-pensar](../concepts/nao-me-faca-pensar.md), [steve-krug](../concepts/steve-krug.md), [navegacao-web](../concepts/navegacao-web.md), [reservatorio-boa-vontade](../concepts/reservatorio-boa-vontade.md), [testes-usabilidade](../concepts/testes-usabilidade.md)
